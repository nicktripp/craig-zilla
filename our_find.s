...
# struct trie_t 108 bytes
# {
# 	const char *word;  4 bytes
# 	trie_t *next[26];  104 bytes
# };
TRIE:  .word 0
.space  10800
...
alloc_trie:
	...
	la 	$t0, TRIE
	lw 	$t1, 0($t0) 		# t0 = numNodes

	mul	$t2, $t1, 108 		# t2 = 108*numNodes

	add 	$t1, $t1, 1
	sw 	$t1, 0($t0) 		# t0 = numNodes

	add 	$t0, $t0, 4
	add 	$v0, $t0, $t2		# t3 = &trieNode[numNodes]
